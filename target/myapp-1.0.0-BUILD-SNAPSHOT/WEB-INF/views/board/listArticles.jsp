...
<head>
    <meta charset="UTF-8">
    <title>게시글 목록</title>
    <link rel="stylesheet" href="${contextPath}/css/board/listArticles.css" />
</head>
<body>
<div class="article-container">
    ...
    <div class="write-button">
        <a href="javascript:fn_articleForm('${isLogOn}', '${contextPath}/board/articleForm.do', '${contextPath}/member/loginForm.do')">글쓰기</a>
    </div>
</div>
